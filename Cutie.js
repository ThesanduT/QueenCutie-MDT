...
module.exports = CutieTTM = async (CutieTTM, m, chatUpdate, store) => {
	...
	//group target \\
const reply = (teks) => {
            CutieTTM.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Gojo-Satoru`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./CutieMedia/Cutie.jpg`),"sourceUrl": "https://telegra.ph/file/8bbe8a7de5c351dfcb077.jpg"}}}, { quoted: m})
        }
